...
% cache trainval
spp_window_data_param.cache_dir = '/x/ronghang/voc2007/trainval';
rcnn_make_spp_cache(imdb_trainval, ...
    net_proto_file, net_binary_file, spp_window_data_param);

% cache test
spp_window_data_param.cache_dir = '/x/ronghang/voc2007/test';
