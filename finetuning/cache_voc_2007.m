...
% rcnn_make_window_file(imdb_trainval, 'external/caffe/examples/pascal-finetuning_voc2007');
...
% rcnn_make_window_file(imdb_test, 'external/caffe/examples/pascal-finetuning_voc2007');
