...
try
  ...
  devkit_path = './datasets/ILSVRC13/ILSVRC2013_devkit';
  if exist(devkit_path, 'dir') == 0
    error('please install ILSVRC devkit into %s', devkit_path);
  end
  addpath(fullfile(devkit_path, 'evaluation'));
